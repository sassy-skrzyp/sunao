...
export default function FeaturesSection() {
  ...
  const features = [{
    ...
    mpid: "9b922e2b-a2a8-4f65-8185-f38bea133e82"
  }, {
    ...
    mpid: "fe0bd738-11da-49eb-9d9b-70673a5cadbb"
  }, {
    ...
    mpid: "470e8f03-9c88-446a-ab91-b2d8eeda1987"
  }, {
    ...
    mpid: "274db494-f151-4f75-bd82-22476e67a2b9"
  }, {
    ...
    mpid: "db0a7bc7-f319-4e35-ae14-6ed0c9d54e9f"
  }, {
    ...
    mpid: "a5c25608-a345-4da9-9d79-3f34aa374d80"
  }] as any[];
    ...
    letterSpacing: '-0.06em'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-magicpath-id="7" data-magicpath-path="FeaturesSection.tsx">
        ...
        once: true
          ...
          letterSpacing: '-0.06em'
        }} data-magicpath-id="12" data-magicpath-path="FeaturesSection.tsx">
                  ...
                  <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8" data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-id="24" data-magicpath-path="FeaturesSection.tsx">
                    ...
                    <div className="flex-1 space-y-6" data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-id="25" data-magicpath-path="FeaturesSection.tsx">
                      <div className="flex items-center gap-4" data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-id="26" data-magicpath-path="FeaturesSection.tsx">
                        <div className="text-pink-500 bg-pink-50 p-3 rounded-xl" data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-field="icon:unknown" data-magicpath-id="27" data-magicpath-path="FeaturesSection.tsx">
                          {feature.icon}
                        </div>
                        ...
                        letterSpacing: '-0.06em'
                      }} data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-field="title:unknown" data-magicpath-id="29" data-magicpath-path="FeaturesSection.tsx">
                            {feature.title}
                          </h3>
                        </div>
                      </div>
                    ...
                    letterSpacing: '-0.06em'
                  }} data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-field="description:unknown" data-magicpath-id="30" data-magicpath-path="FeaturesSection.tsx">
                        {feature.description}
                      </p>
                      ...
                      letterSpacing: '-0.06em'
                    }} data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-field="stats:unknown" data-magicpath-id="33" data-magicpath-path="FeaturesSection.tsx">
                          {feature.stats}
                        </span>
                    ...
                    <div className="flex-shrink-0 lg:w-64 h-48 bg-gray-50 rounded-xl flex items-center justify-center" data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-id="35" data-magicpath-path="FeaturesSection.tsx">
                      <div className="text-pink-300 scale-150" data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-field="icon:unknown" data-magicpath-id="36" data-magicpath-path="FeaturesSection.tsx">
                        {feature.icon}
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-16 text-center" data-magicpath-id="37" data-magicpath-path="FeaturesSection.tsx">
          ...
          letterSpacing: '-0.06em'
        }} data-magicpath-id="38" data-magicpath-path="FeaturesSection.tsx">Explore all features</p>
          <div className="flex flex-wrap justify-center gap-2 md:gap-3" data-magicpath-id="39" data-magicpath-path="FeaturesSection.tsx">
            ...
            letterSpacing: '-0.06em'
          }} data-magicpath-uuid={(feature as any)["mpid"] ?? "unsafe"} data-magicpath-field="title:unknown" data-magicpath-id="40" data-magicpath-path="FeaturesSection.tsx">
                {feature.title}
              </button>)}
          </div>
        </div>
